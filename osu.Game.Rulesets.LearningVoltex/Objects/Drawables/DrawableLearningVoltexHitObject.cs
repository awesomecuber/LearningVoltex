...
namespace osu.Game.Rulesets.LearningVoltex.Objects.Drawables
{
    public class DrawableLearningVoltexHitObject : DrawableHitObject<LearningVoltexHitObject>
    {
        private BindableNumber<int> currentLane;

        public DrawableLearningVoltexHitObject(LearningVoltexHitObject hitObject)
            : base(hitObject)
        {
            Size = new Vector2(40);

            Origin = Anchor.Centre;
            Y = hitObject.Lane * LearningVoltexPlayfield.LANE_HEIGHT;
        }

        [BackgroundDependencyLoader]
        private void load(LearningVoltexPlayfield playfield, TextureStore textures)
        {
