...
{
    [Cached]
    public class LearningVoltexPlayfield : ScrollingPlayfield
    {
        public const float LANE_HEIGHT = 70;

        public const int LANE_COUNT = 6;

        public BindableInt CurrentLane => learningvoltex.LanePosition;

        private LearningVoltexCharacter learningvoltex;
            ...
            AddRangeInternal(new Drawable[]
            {
                new LaneContainer
                {
                    ...
                    Child = new Container
                    {
                        ...
                        {
                            HitObjectContainer,
                            learningvoltex = new LearningVoltexCharacter
                            {
